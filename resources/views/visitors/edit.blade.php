...
<div class="box">
	...
	<!-- form start -->
    <form role="form" action="{{ route('visitor.update', ['visitor'=>$visitor->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="box-body">
            <div class="col-md-3">
            ...
            <div class="col-md-9">                
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Digite o seu nome completo sem abreviar" required="" autofocus="" value="{{ $visitor->fullname }}">
                    </div>
                </div>  
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="birthday" name="birthday" placeholder="xxxx-xx-xx" value="{{ $visitor->birthday }}">
                        </div>
                        <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="phone" name="phone" placeholder="(xx) xxxxx-xxxx" required="" value="{{ $visitor->phone }}">
                    </div>
                </div>              
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="rg" name="rg" placeholder="xx.xxx.xxx-x" value="{{ $visitor->rg }}">
                    </div>

                    <div class="form-group col-md-6">
                        <label for="cpf">CPF</label><span class="text-muted" style="margin-left: 10px">(Opcional)</span>
                        <input type="text" class="form-control" id="cpf" name="cpf" placeholder="xxx.xxx.xxx-xx" value="{{ $visitor->cpf }}">
                    </div>
                </div>                
